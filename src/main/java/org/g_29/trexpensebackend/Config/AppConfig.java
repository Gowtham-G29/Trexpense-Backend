...
public class AppConfig {
    ...
    SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        ...
        http.authorizeHttpRequests(authorizedRequests->authorizedRequests.requestMatchers("/login","/register","/activateAccount","/sentPasswordResetEmail","/resetPassword","/contactUs").permitAll().anyRequest().authenticated());
